...
from cco import Synthetic30Env
...
def parse():
    ...
    parser.add_argument("-n", "--num_services", type=int, default=30,
    ...
    parser.add_argument('-e', "--ensembles",type=int,default=8, 
    ...
    parser.add_argument("--selection_times",type=int,default=0,
                        help="number of patterns selected")  
    parser.add_argument("--experiment_setting",type=str, default='nonlinear_real_daily',
...
def main(args):
    ...
    for i, seed in enumerate(default_seeds):
        ...
        env = Synthetic30Env(num_services=num_services, alpha=alpha, seed=seed, experiment_setting=experiment_setting)
